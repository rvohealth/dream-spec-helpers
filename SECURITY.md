...
We currently support the latest version of dream-spec-helpers v2. Our goal is to avoid breaking changes within major versions, facilitating incorporating security patches by updating to the latest minor and patch version within a supported major version.
